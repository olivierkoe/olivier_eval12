...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'olivierKOENIGdevopps34VOYAGE_c1eb0ff5976565728848_20220329102729_archive.zip';
	const ARCHIVE_SIZE		 = '52619735';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c1eb0ff-29102729';
    const SECONDARY_PACKAGE_HASH = 'bc9a430-29102729';
	const VERSION			 = '1.4.4';
